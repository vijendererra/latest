...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AouthGuard", function() { return AouthGuard; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services_loginandregistration_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/loginandregistration.service */ "./src/app/services/loginandregistration.service.ts");




let AouthGuard = class AouthGuard {
...
let AuthInterceptor = class AuthInterceptor {
    ...
    intercept(req, next) {
        ...
        if (localStorage.getItem('token') != null) {
            ...
            return next.handle(clondreq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(event => { }, err => {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _aouth_aouth_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./aouth/aouth.guard */ "./src/app/aouth/aouth.guard.ts");
...
const routes = [
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | login-registration-login-module */ "login-registration-login-module").then(__webpack_require__.bind(null, /*! ./login-registration/login.module */ "./src/app/login-registration/login.module.ts")).then(m => m.LoginModule)
    },
    {
        path: 'curd',
        // loadChildren:'./crud/crud.module#CrudModule',canActivate:[AouthGuard]
        loadChildren: () => __webpack_require__.e(/*! import() | crud-crud-module */ "crud-crud-module").then(__webpack_require__.bind(null, /*! ./crud/crud.module */ "./src/app/crud/crud.module.ts")).then(m => m.CrudModule), canActivate: [_aouth_aouth_guard__WEBPACK_IMPORTED_MODULE_3__["AouthGuard"]]
    },
    {
        path: 'forgotpwd',
        loadChildren: () => __webpack_require__.e(/*! import() | resetpassword-resetpassword-module */ "resetpassword-resetpassword-module").then(__webpack_require__.bind(null, /*! ./resetpassword/resetpassword.module */ "./src/app/resetpassword/resetpassword.module.ts")).then(m => m.ResetpasswordModule)
    },
    {
...
/* harmony import */ var _services_loginandregistration_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/loginandregistration.service */ "./src/app/services/loginandregistration.service.ts");
/* harmony import */ var _aouth_intersepter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./aouth/intersepter */ "./src/app/aouth/intersepter.ts");
/* harmony import */ var _aouth_aouth_guard__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./aouth/aouth.guard */ "./src/app/aouth/aouth.guard.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        providers: [{
            ...
            _services_loginandregistration_service__WEBPACK_IMPORTED_MODULE_8__["LoginandregistrationService"],
            _aouth_aouth_guard__WEBPACK_IMPORTED_MODULE_10__["AouthGuard"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MeterialModule", function() { return MeterialModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let MeterialModule = class MeterialModule {
};
MeterialModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [],
        imports: [
...
let CrudService = class CrudService {
    ...
    getEmp() {
        // const url='/g';
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/g';
        return this.http.get(url);
    }
    postEmp(model) {
        // const url='/p';
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/p';
        return this.http.post(url, model);
    }
    putEmp(model) {
        // const url='/'+model._id;
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/' + model._id;
        return this.http.put(url, model);
    }
    deleteEmp(_id) {
        // const url='/'+_id;
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/' + _id;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoginandregistrationService", function() { return LoginandregistrationService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../environments/environment */ "./src/environments/environment.ts");
...
let LoginandregistrationService = class LoginandregistrationService {
    constructor(http) {
        this.http = http;
        this.noAuthHeader = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
    ...
    postEmp(model) {
        ...
        // const url = '/reg';
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/reg';
    ...
    loginUser(log) {
        // const url = '/login';
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/login';
    ...
    logedin() {
        // const url = '/logedin';
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/logedin';
    ...
    forGotPwd(email) {
        // const url = '/forgotpwd';
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/forgotpwd';
    ...
    resetPwd(pwd, token) {
        ...
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + '/resetpwd/' + token;
...
LoginandregistrationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
LoginandregistrationService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
/* harmony import */ var _meterial_meterial_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../meterial/meterial.module */ "./src/app/meterial/meterial.module.ts");
...
SharedModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            primeng_button__WEBPACK_IMPORTED_MODULE_4__["ButtonModule"],
            _meterial_meterial_module__WEBPACK_IMPORTED_MODULE_5__["MeterialModule"],
...
module.exports = __webpack_require__(/*! F:\vijender\projects\All Features\angular8\src\main.ts */"./src/main.ts");
